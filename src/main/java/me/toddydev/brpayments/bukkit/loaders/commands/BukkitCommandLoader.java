package me.toddydev.brpayments.bukkit.loaders.commands;
...
public class BukkitCommandLoader {
    ...
    public static void load(JavaPlugin instance) {
        for (Class<?> commandClass : ClassGetter.getClassesForPackage(instance, "me.toddydev.brpayments.bukkit.commands.register")) {
