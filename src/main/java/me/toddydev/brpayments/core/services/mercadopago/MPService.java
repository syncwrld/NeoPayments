package me.toddydev.brpayments.core.services.mercadopago;
...
import me.toddydev.brpayments.core.utils.keys.RandomKey;
import okhttp3.*;
...
import static me.toddydev.brpayments.core.model.order.status.OrderStatus.WAITING;
...
public class MPService {
    ...
    public Order create(Order order) {
        ...
        try {
            ...
            Bukkit.getConsoleSender().sendMessage("§b[NeoPayments] Ocorreu um erro ao tentar criar um pagamento com o Mercado Pago: " + e.getLocalizedMessage());
            return null;
        }
    }
